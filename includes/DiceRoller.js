...
export class DiceRoller {
	...
	constructor(imagesList) {
		...
		this.roomlist_button = Teal.id('roomslist_button');
		...
		Teal.bind(this.roomlist_button, 'click', this.getRoomsList);
		Teal.bind(this.roomlist_button, ['mousedown', 'mouseup', 'touchstart', 'touchend'], function(ev) { ev.stopPropagation(); });
		Teal.bind(this.roomlist_button, 'focus', function(ev) { Teal.set(this.desk, { class: '' }); });
		Teal.bind(this.roomlist_button, 'blur', function(ev) { Teal.set(this.desk, { class: 'noselect' }); });
	...
	getRoomsList() {
		if (window.DiceRoller.Teal.socket && window.DiceRoller.Teal.socket.readyState <= WebSocket.OPEN) {
			window.DiceRoller.Teal.rpc({method:'roomlist'});
		} else {
			window.DiceRoller.connect_socket(true, window.DiceRoller.getRoomsList);
		}
	}
